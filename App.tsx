...
import ChapterDetail1 from './components/ChapterDetail1';
...
type HomeStackProps = StackScreenProps<any, 'Home'>;

function HomeStack({ route }: HomeStackProps) {
  const { email } = route.params || {};

  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      <Stack.Screen name="Home" component={Home} initialParams={{ email }} />
      <Stack.Screen name="ChapterList" component={ChapterList} />
      <Stack.Screen name="Profile" component={Profile} initialParams={{ email }} />
      <Stack.Screen name="ChapterDetail" component={ChapterDetail} />
      <Stack.Screen name="ChapterDetail1" component={ChapterDetail1} />
      {/* Book_1 */}
      <Stack.Screen name="ChapterDetail1_1" component={ChapterDetail1_1} />
      <Stack.Screen name="ChapterDetail1_2" component={ChapterDetail1_2} />
      <Stack.Screen name="ChapterDetail1_3" component={ChapterDetail1_3} />
      <Stack.Screen name="ChapterDetail1_4" component={ChapterDetail1_4} />
      <Stack.Screen name="ChapterDetail1_5" component={ChapterDetail1_5} />
      {/* Book_2 */}
      <Stack.Screen name="ChapterDetail2_1" component={ChapterDetail2_1} />
      <Stack.Screen name="ChapterDetail2_2" component={ChapterDetail2_2} />
      <Stack.Screen name="ChapterDetail2_3" component={ChapterDetail2_3} />
      <Stack.Screen name="ChapterDetail2_4" component={ChapterDetail2_4} />
      <Stack.Screen name="ChapterDetail2_5" component={ChapterDetail2_5} />
      {/* Book_3 */}
      <Stack.Screen name="ChapterDetail3_1" component={ChapterDetail3_1} />
      <Stack.Screen name="ChapterDetail3_2" component={ChapterDetail3_2} />
      <Stack.Screen name="ChapterDetail3_3" component={ChapterDetail3_3} />
      <Stack.Screen name="ChapterDetail3_4" component={ChapterDetail3_4} />
      <Stack.Screen name="ChapterDetail3_5" component={ChapterDetail3_5} />
      {/* Book_4 */}
      <Stack.Screen name="ChapterDetail4_1" component={ChapterDetail4_1} />
      <Stack.Screen name="ChapterDetail4_2" component={ChapterDetail4_2} />
      <Stack.Screen name="ChapterDetail4_3" component={ChapterDetail4_3} />
      <Stack.Screen name="ChapterDetail4_4" component={ChapterDetail4_4} />
      <Stack.Screen name="ChapterDetail4_5" component={ChapterDetail4_5} />
      {/* Book_5 */}
      <Stack.Screen name="ChapterDetail5_1" component={ChapterDetail5_1} />
      <Stack.Screen name="ChapterDetail5_2" component={ChapterDetail5_2} />
      <Stack.Screen name="ChapterDetail5_3" component={ChapterDetail5_3} />
      <Stack.Screen name="ChapterDetail5_4" component={ChapterDetail5_4} />
      <Stack.Screen name="ChapterDetail5_5" component={ChapterDetail5_5} />
      {/* Book_6 */}
      <Stack.Screen name="ChapterDetail6_1" component={ChapterDetail6_1} />
      <Stack.Screen name="ChapterDetail6_2" component={ChapterDetail6_2} />
      <Stack.Screen name="ChapterDetail6_3" component={ChapterDetail6_3} />
      <Stack.Screen name="ChapterDetail6_4" component={ChapterDetail6_4} />
      <Stack.Screen name="ChapterDetail6_5" component={ChapterDetail6_5} />
      {/* Book_7 */}
      <Stack.Screen name="ChapterDetail7_1" component={ChapterDetail7_1} />
      <Stack.Screen name="ChapterDetail7_2" component={ChapterDetail7_2} />
      <Stack.Screen name="ChapterDetail7_3" component={ChapterDetail7_3} />
      <Stack.Screen name="ChapterDetail7_4" component={ChapterDetail7_4} />
      <Stack.Screen name="ChapterDetail7_5" component={ChapterDetail7_5} />
      {/* Book_8 */}
      <Stack.Screen name="ChapterDetail8_1" component={ChapterDetail1_1} />
      <Stack.Screen name="ChapterDetail8_2" component={ChapterDetail1_2} />
      <Stack.Screen name="ChapterDetail8_3" component={ChapterDetail1_3} />
      <Stack.Screen name="ChapterDetail8_4" component={ChapterDetail1_4} />
      <Stack.Screen name="ChapterDetail8_5" component={ChapterDetail1_5} />
    </Stack.Navigator>
  );
}
