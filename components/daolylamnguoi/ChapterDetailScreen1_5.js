...
export default function ChapterDetail({ route, navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Image
        source={require('../../assets/cang ky luat cang tu do 7.png')}
        style={styles.image}
      />
      <Image
        source={require('../../assets/cang ky luat cang tu do 8.png')}
        style={styles.image}
      />
      <Image
        source={require('../../assets/cang ky luat cang tu do 9.jpg')}
        style={styles.image}
      />
