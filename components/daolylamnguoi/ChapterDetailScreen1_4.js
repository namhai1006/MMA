...
export default function ChapterDetail({ route, navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Image
        source={require('../../assets/cang ky luat cang tu do 4.jpg')}
        style={styles.image}
      />
      <Image
        source={require('../../assets/cang ky luat cang tu do 5.jpg')}
        style={styles.image}
      />
      <Image
        source={require('../../assets/cang ky luat cang tu do 6.png')}
        style={styles.image}
      />
