...
export default function ChapterDetail({ route, navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Image
        source={require('../../assets/cang ky luat cang tu do 1.png')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
      <Image
        source={require('../../assets/cang ky luat cang tu do 2.png')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
      <Image
        source={require('../../assets/cang ky luat cang tu do 3.png')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
