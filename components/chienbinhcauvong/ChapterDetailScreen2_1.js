...
export default function ChapterDetail2({ route, navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Image
        source={require('../../assets/chien binh cau vong 1.png')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
      <Image
        source={require('../../assets/chien binh cau vong 2.jpg')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
      <Image
        source={require('../../assets/chien binh cau vong 3.png')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
