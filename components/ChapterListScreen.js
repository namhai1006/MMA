...
export default function ChapterList({ route, navigation }) {
      ...
      case 'Càng Kỷ Luật Càng Tự Do':
        switch (chapter) {
          ...
          case 'Chương 5':
            ...
            break;
          default:
            navigation.navigate('ChapterDetail1', { title: chapter, bookTitle: title, chapters });
            break;
        }
        break;
  ...
  const handleSearch = (query) => {
    ...
    if (query) {
      const filtered = chapters.filter((chapter) =>
        chapter.toLowerCase().includes(query.toLowerCase())
      );
  ...
  const handleCreateChapter = () => {
    const newChapter = `Chương ${filteredChapters.length + 1}`;
    const updatedChapters = [...filteredChapters, newChapter];
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalView}>
            <Text style={styles.modalTitle}>Create New Chapter</Text>
            <TextInput
            ...
            />
            <TouchableOpacity style={styles.modalButton} onPress={handleCreateChapter}>
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalView}>
            <TouchableOpacity style={styles.modalButton} onPress={() => { setMenuModalVisible(false); navigation.navigate('Home'); }}>
              <Text style={styles.modalButtonText}>Home</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton} onPress={() => { setMenuModalVisible(false); navigation.navigate('Favorites'); }}>
              <Text style={styles.modalButtonText}>Favorite</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton} onPress={() => setMenuModalVisible(false)}>
              <Text style={styles.modalButtonText}>Cancel</Text>
            </TouchableOpacity>
          </View>
        </View>
