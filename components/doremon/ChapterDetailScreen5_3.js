...
export default function ChapterDetail2({ route, navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Image
        source={require('../../assets/doremon 1.jpg')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
      <Image
        source={require('../../assets/doremon 2.jpg')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
      <Image
        source={require('../../assets/doremon 3.jpg')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
