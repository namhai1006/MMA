...
export default function ChapterDetail2({ route, navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Image
        source={require('../../assets/conan7.jpg')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
      <Image
        source={require('../../assets/conan 8jpg.jpg')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
      <Image
        source={require('../../assets/conan 9.jpg')} // Thay thế bằng đường dẫn đến ảnh của bạn
        style={styles.image}
      />
